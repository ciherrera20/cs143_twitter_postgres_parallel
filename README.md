...
|     | sequential | parallel |
| --- | ---------- | -------- |
| normalized (unbatched) | ![](https://github.com/ciherrera20/cs143_twitter_postgres_parallel/workflows/tests_normalized_sequential/badge.svg) | ![](https://github.com/ciherrera20/cs143_twitter_postgres_parallel/workflows/tests_normalized_parallel/badge.svg) |
| normalized (batched) | ![](https://github.com/ciherrera20/cs143_twitter_postgres_parallel/workflows/tests_normalizedbatch_sequential/badge.svg) |  ![](https://github.com/ciherrera20/cs143_twitter_postgres_parallel/workflows/tests_normalizedbatch_parallel/badge.svg) |
| denormalized | ![](https://github.com/ciherrera20/cs143_twitter_postgres_parallel/workflows/tests_denormalized_sequential/badge.svg) | ![](https://github.com/ciherrera20/cs143_twitter_postgres_parallel/workflows/tests_denormalized_parallel/badge.svg) |
...
| -----------------------| ------------------------- | ------------------------- |
| `pg_normalized`        | 9m32.072s                 | 1m20.971s                 | 
| `pg_normalized_batch`  | 2m51.470s                 | 0m27.628s                 | 
| `pg_denormalized`      | 0m17.509s                 | 0m4.120s                  | 
